...
class DirectorModel extends Model {
    ...
    public function create(array $data): int {
        ...
        $stmt = $this->db->prepare("
            ...
            VALUES 
            ('DIRECTOR', :member_no, :party_id, :full_name, :nic, :dob, :gender, :occupation, :phone, :email, :whatsapp, :agricultural_sector, :heir_name, :heir_address, :heir_nic, :heir_contact_number, :address, :city, 
             :registration_date, :status, :registration_fee, :shares_fee, :payment_method, :payment_status, :notes, :journal_entry_id)
        ");
