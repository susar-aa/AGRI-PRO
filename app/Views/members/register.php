<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        ...
        <h4 class="fw-bold mb-1 text-dark">Society Member Registration Form</h4>
        <p class="text-muted small mb-0">Record personal details and membership settings. Posts double-entry bookkeeping transactions if payments are cleared.</p>
    </div>
</div>

<form action="<?= \Core\Helper::baseUrl('modules/members/store'); ?>" method="POST" id="registrationForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="agricultural_sector" id="agri_sector" list="sector_list" placeholder="Search or type new..." autocomplete="off">
            ...
            <div class="card border-0 shadow-sm rounded-4 mt-4">
                <div class="card-body p-3 text-center">
                    <button type="submit" class="btn btn-success rounded-pill w-100" style="background-color: #1b4332; border-color: #1b4332;">
                        <i class="bi bi-save me-1"></i> Register Member
                    </button>
                </div>
            </div>
        </div>
