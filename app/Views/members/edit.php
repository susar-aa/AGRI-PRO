                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="agricultural_sector" id="agri_sector" list="sector_list" placeholder="Search or type new..." autocomplete="off" value="<?= htmlspecialchars($member['agricultural_sector'] ?? '') ?>">
