<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        ...
        <h4 class="fw-bold mb-1 text-dark">Edit Supplier Profile</h4>
...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-body p-4">
        <form action="<?= \Core\Helper::baseUrl('parties/update'); ?>" method="POST" id="partyForm">
            ...
            <input type="hidden" name="party_type" value="<?= $party['party_type']; ?>"> <!-- Keeps BOTH if BOTH -->
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="whatsapp_number" name="whatsapp_number" value="<?= htmlspecialchars($party['whatsapp_number'] ?? ''); ?>">
                </div>
            </div>
