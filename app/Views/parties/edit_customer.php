<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        ...
        <h4 class="fw-bold mb-1 text-dark">Edit Customer Profile</h4>
        <p class="text-muted small mb-0">Modify contact credentials, credit terms, and status variables for: <strong><?= htmlspecialchars($party['name']); ?></strong></p>
    </div>
</div>
    ...
    <div class="card-body p-4">
        <form action="<?= \Core\Helper::baseUrl('parties/update'); ?>" method="POST" id="partyForm">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-3">
                    <label for="customer_activity_id" class="form-label fw-semibold">Activity</label>
                    <select class="form-select" id="customer_activity_id" name="customer_activity_id">
                        <option value="">-- Select Activity --</option>
                        <?php if(!empty($activities)): foreach ($activities as $act): ?>
                            <option value="<?= $act['id']; ?>" <?= ($party['customer_activity_id'] == $act['id']) ? 'selected' : ''; ?>><?= htmlspecialchars($act['name']); ?></option>
                        <?php endforeach; endif; ?>
                    </select>
                </div>
                <div class="col-md-3">
                    <label for="status" class="form-label fw-semibold">Partner Status <span class="text-danger">*</span></label>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="contact_person" name="contact_person" value="<?= htmlspecialchars($party['contact_person'] ?? ''); ?>">
                </div>
                <div class="col-md-4">
