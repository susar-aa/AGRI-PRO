<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        <a href="<?= \Core\Helper::baseUrl('parties/customers'); ?>" class="btn btn-sm btn-outline-secondary rounded-pill mb-2">
            <i class="bi bi-arrow-left me-1"></i> Back to Customers
        </a>
        <h4 class="fw-bold mb-1 text-dark">Register Customer</h4>
        <p class="text-muted small mb-0">Add a new customer to the cooperative ledger system.</p>
    </div>
</div>
    ...
    <div class="card-body p-4">
        <form action="<?= \Core\Helper::baseUrl('parties/store'); ?>" method="POST" id="partyForm">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    <label for="customer_activity_id" class="form-label fw-semibold">Activity (Why Registered)</label>
            ...
            <div class="modal-footer bg-light p-3 rounded-3 mt-4 gap-2">
                <a href="<?= \Core\Helper::baseUrl('parties/customers'); ?>" class="btn btn-secondary rounded-pill px-3">Cancel</a>
                <button type="submit" class="btn btn-success rounded-pill px-4" style="background-color: #1b4332; border-color: #1b4332;">Register Customer</button>
            </div>
        </form>
    </div>
</div>
