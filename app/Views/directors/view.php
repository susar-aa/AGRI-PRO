            ...
            <div class="card-body pt-0 small">
                <div class="row g-3">
                    ...
                    <div class="col-6 col-md-4 mt-3">
                        ...
                        <span class="fw-bold text-dark"><?= htmlspecialchars($director['whatsapp'] ?: 'N/A'); ?></span>
                    </div>
                    <div class="col-6 col-md-4 mt-3">
                        <small class="text-muted d-block">Email Address</small>
                        <span class="fw-bold text-dark"><?= htmlspecialchars($director['email'] ?: 'N/A'); ?></span>
                    </div>
                    <div class="col-6 col-md-4 mt-3">
                        <small class="text-muted d-block">Occupation</small>
                        <span class="fw-bold text-dark"><?= htmlspecialchars($director['occupation'] ?: 'N/A'); ?></span>
                    </div>
                    ...
                    <div class="col-12 mt-3 pt-2 border-top">
                        ...
                        <div>
                            <?php 
                            $sectors = explode(',', $director['agricultural_sector'] ?? '');
                            $hasSectors = false;
