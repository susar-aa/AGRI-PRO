                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?= \Core\Helper::baseUrl('modules/directors/view?id=' . $m['id']); ?>" class="btn btn-outline-success px-3" title="Profile"><i class="bi bi-person-fill"></i> Profile</a>
                                                <a href="<?= \Core\Helper::baseUrl('modules/directors/edit?id=' . $m['id']); ?>" class="btn btn-outline-primary px-3" title="Edit"><i class="bi bi-pencil-square"></i></a>
