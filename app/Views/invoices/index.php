...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-body p-3">
        <form action="<?= \Core\Helper::baseUrl('modules/invoices'); ?>" method="GET" class="row g-3 small">
            <div class="col-12 col-md-3">
                <label class="form-label fw-semibold">Search Invoice</label>
                <input type="text" class="form-control form-control-sm" name="search" value="<?= htmlspecialchars($filters['search']); ?>" placeholder="Invoice #, reference, notes...">
            </div>
            ...
            <div class="col-6 col-md-2 d-flex align-items-end gap-2">
                ...
                <a href="<?= \Core\Helper::baseUrl('modules/invoices'); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3 w-100">Reset</a>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                        ...
                        <?php foreach ($invoices as $inv): ?>
                            <tr>
                                <td class="fw-bold font-monospace">
                                    <a href="<?= \Core\Helper::baseUrl('modules/invoices/view?id=' . $inv['id']); ?>" class="text-success text-decoration-none">
                                ...
                                <td>
                                    ...
                                    <small class="text-muted font-monospace"><?= htmlspecialchars($inv['party_code']); ?></small>
                                </td>
                                <td class="text-end fw-bold text-dark font-monospace"><?= \Core\Helper::formatCurrency($inv['total']); ?></td>
                                <td>
                                    <span class="badge bg-light text-dark border"><?= htmlspecialchars($inv['payment_type']); ?></span>
                                </td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">No central invoices recorded.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
