...
class ReportController extends Controller {
    ...
    private function exportExcel(array $records, array $filters, array $company, string $generatedBy, string $generatedAt): void {
        ...
        <body>
            <table>
                <tr>
                    <td colspan="8" class="title-row"><?= htmlspecialchars($companyNameEn); ?></td>
                </tr>
                <tr>
                    <td colspan="8" class="subtitle-row"><?= htmlspecialchars($companyNameSi); ?> - <?= htmlspecialchars($addressEn); ?></td>
                </tr>
                <tr>
                    <td colspan="8" class="subtitle-row" style="font-size: 14px; font-weight: bold; color: #047857; padding-top: 5px;">DIRECTORY REPORT (<?= strtoupper($typeName); ?>)</td>
                </tr>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 110px;">Code / Reg No</th>
                        <th style="width: 200px;">Full Name</th>
                        <th style="width: 120px;">Phone Number</th>
                        <th style="width: 120px;">NIC / Reg No</th>
                ...
                <tbody>
                    <?php if (empty($records)): ?>
                        <tr>
                            <td colspan="8" style="text-align: center; color: #6b7280; padding: 15px;">No directory records match the selected filter and search criteria.</td>
                        </tr>
                    <?php else: ?>
